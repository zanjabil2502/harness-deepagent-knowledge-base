...
| 38-40 | `concepts/multilingual.md:58,161,228` | Language-locked points in the intent/expression pipeline | outside `deepagents` |
| 41-45 | `concepts/persistence-schema.md:37,300,345,351,359` | A local `users` table; RLS without subqueries; naming; the `user_id`→`tenant_id` migration path | outside `deepagents` |
